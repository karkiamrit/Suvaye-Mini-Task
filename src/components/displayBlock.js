        ...
        <div className="relative bg-white w-full h-[1511px] overflow-hidden text-left text-xl text-black font-vazirmatn">
            ...
            <div className="absolute top-[214px] left-[230px] w-[980px] h-[626px] font-text-xl-regular">
                ...
                <div className="absolute top-[126px] left-[31px] bg-gainsboro rounded-8xs w-[93px] h-[33px] overflow-hidden text-center">
                    <button
                        className={`w-full h-full focus:outline-none font-medium text-lg ${type === "noun" ? "bg-black text-white" : "bg-transparent"
                            }`}
                        value="noun"
                        onClick={handleClick}
                    >
                ...
                <div className="absolute top-[126px] left-[137px] bg-gainsboro rounded-8xs w-[93px] h-[33px] overflow-hidden text-center">
                    <button
                        className={`w-full h-full focus:outline-none font-medium text-lg ${type === "verb" ? "bg-black text-white" : "bg-transparent"
                            }`}
                        value="verb"
                        onClick={handleClick}
                    >
